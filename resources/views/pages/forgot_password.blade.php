							...
							<div class="card-front">
								<div class="center-wrap">
									<div class="section text-center">
										...
										<form action="{{URL::to('/save-password/'.$email)}}" method="POST">
											@csrf	
											<div class="form-group">
												<input type="email" disabled value="{{$email}}" name="email" class="form-style" placeholder="Email của bạn" id="logemail" autocomplete="off">
												<i class="input-icon uil uil-at"></i>
											</div>	
                                            <div class="form-group mt-2">
												<input type="password" name="password" class="form-style" placeholder="Mật khẩu mới của bạn" id="pw" autocomplete="off">
												<i class="fa-solid fa-eye input-eye" id="eye" onclick="showPass()"></i>
												<i class="input-icon uil uil-lock-alt" ></i>
											</div>
                                            <div class="form-group mt-2">
												<input type="password" name="repassword" class="form-style" placeholder="Nhập lại mật khẩu" id="pw1" autocomplete="off">
