								...
								<div class="p-5">
									<form class="user" action="{{route('admin.signIn')}}" method="POST">
										...
										<div class="form-group">
											<input type="text" class="form-control form-control-user" name="username" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Tài khoản">
											@error('username')
										...
										<p class="small text-danger">@php echo session('error') @endphp</p>
									...
									<div class="text-center">
										<a class="small">Đăng ký tài khoản!</a>
									</div>
								</div>
							</div>
						</div>
